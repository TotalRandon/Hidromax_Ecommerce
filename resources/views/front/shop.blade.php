    ...
    <div class="container">
        <div class="light-font">
            <ol class="breadcrumb primary-color mb-0">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('front.shop') }}">Loja</a></li>
            </ol>
        </div>
    </div>
</section>
...
<section class="section-6 pt-5">
    <div class="container">
        <div class="row"> 
            <!-- Botão de Filtros para dispositivos menores que lg -->
            <div class="col-12 d-lg-none mb-3">
                <button class="btn btn-primary w-100" id="toggleFilters">Filtros</button>
            </div>
...
<script>
    ...
    // Mostrar/ocultar filtros em dispositivos menores que lg
